...
Para obtener información sobre la solución de problemas, consulte link:..https://kb.netapp.com/mgmt/SnapCenter/SnapCenter_MFA_login_error_The_SAML_message_response_1_doesnt_match_the_expected_response_2["El inicio de sesión de SnapCenter en varias pestañas muestra un error de MFA"].
