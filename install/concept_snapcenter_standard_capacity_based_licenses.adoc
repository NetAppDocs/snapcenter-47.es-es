...
+
image::../media/nss_license_selection.gif[licencia]
...
. En la sección Licencia de la página Software, haga clic en *Agregar* (image:../media/add_policy_from_resourcegroup.gif["añada una política desde el grupo de recursos"]).
