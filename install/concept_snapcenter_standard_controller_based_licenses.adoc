...
+
** image:../media/controller_licensed_icon.gif["icono de licencia del controlador"] Indica que hay una licencia de SnapManager Suite instalada en un sistema de almacenamiento primario FAS o AFF.
** image:../media/controller_not_licensed_icon.gif["icono de controlador sin licencia"] Indica que no hay una licencia de SnapManager Suite instalada en un sistema de almacenamiento primario FAS o AFF.
...
+
image::../media/nss_controller_license_select.gif[seleccione la licencia de la controladora]
...
+
Para obtener información sobre los cmdlets, consulte https://docs.netapp.com/us-en/snapcenter-cmdlets-47/index.html["Guía de referencia de cmdlets de SnapCenter Software"^].
