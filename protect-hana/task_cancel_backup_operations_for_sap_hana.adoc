...
'''
permalink: Protect-hana/task_cancel_backup_operations_for_sap_hana.html barra lateral: Palabras clave: Resumen: 'Puede cancelar operaciones de copia de seguridad que están en cola.' --- = Cancelar operaciones de copia de seguridad para SAP HANA :íconos: Font :imagesdir: ../media/
