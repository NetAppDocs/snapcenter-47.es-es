...
. En la vista Manage Copies, seleccione el recurso clonado (por ejemplo, la base de datos o el LUN) y, a continuación, haga clic en *image:../media/split_cone.gif["icono de división de clones"].
