...
+
Para obtener más información sobre cmdlets de Windows, consulte https://docs.netapp.com/us-en/snapcenter-cmdlets-47/index.html["Guía de referencia de cmdlets de SnapCenter Software"^].

+
Para obtener más información sobre comandos UNIX, consulte https://library.netapp.com/ecm/ecm_download_file/ECMLP2883301["Guía de referencia de comandos del software SnapCenter"^].
