...
Al crear un backup para bases de datos de Oracle, se crea un archivo de bloqueo operativo (_.sm_lock_dbsid_) en el host de la base de datos de Oracle, en el directorio _$ORACLE_HOME/DBS_, para evitar que se ejecuten varias operaciones en la base de datos. Después de realizar el backup de la base de datos, se elimina automáticamente el archivo de bloqueo operativo.
