...
'''
permalink: Protect-sql/task_clone_backups_using_powershell_cmdlets_for_sql.html barra lateral: Palabras clave de la barra lateral: Resumen de clon: 'El flujo de trabajo del clon incluye la planificación, la realización de la operación de clonado y la supervisión de la operación'. --- = Clonar copias de seguridad utilizando cmdlets de PowerShell :íconos: Font :imagesdir: ../media/
