...
.. En la columna *Configure Schedules*, haga clic en *image:../media/add_policy_from_resourcegroup.gif["añada una política desde el grupo de recursos"]* para la política que desea configurar.
